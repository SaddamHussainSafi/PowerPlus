...
<div class="wrap pkwt-ui">
	<h1><?php esc_html_e( 'Security', 'powerkit-powerful-tools-for-your-website' ); ?></h1>
	<details class="pkwt-learn-more">
		<summary><?php esc_html_e( 'Learn More', 'powerkit-powerful-tools-for-your-website' ); ?></summary>
		<p><?php esc_html_e( 'Recommended baseline: enable rate limiting, set lockout values, and block native WordPress auth endpoints after custom login URL is verified.', 'powerkit-powerful-tools-for-your-website' ); ?></p>
	</details>
	<?php settings_errors(); ?>
	...
	<form method="post" action="options.php" class="pkwt-settings-form">
		...
		<div class="pkwt-savebar pkwt-savebar-top">
			<div class="pkwt-savebar-text"><?php esc_html_e( 'Review protection rules before saving.', 'powerkit-powerful-tools-for-your-website' ); ?></div>
		...
		<div class="pkwt-card-grid">
			<section class="pkwt-card">
				<h2><?php esc_html_e( 'Login Protection', 'powerkit-powerful-tools-for-your-website' ); ?></h2>
				<div class="pkwt-field pkwt-field-inline">
					<label class="pkwt-label" for="pkwt-rate-limiting"><?php esc_html_e( 'Enable rate limiting', 'powerkit-powerful-tools-for-your-website' ); ?></label>
					<div class="pkwt-switch-wrap">
						<input type="hidden" name="pkwt_settings[enable_rate_limiting]" value="0" />
						<label class="pkwt-switch" aria-label="<?php esc_attr_e( 'Enable rate limiting', 'powerkit-powerful-tools-for-your-website' ); ?>">
				...
				<div class="pkwt-field-grid">
					<div class="pkwt-field">
						<label class="pkwt-label" for="pkwt-max-attempts"><?php esc_html_e( 'Max login attempts', 'powerkit-powerful-tools-for-your-website' ); ?></label>
					...
					<div class="pkwt-field">
						<label class="pkwt-label" for="pkwt-lockout-mins"><?php esc_html_e( 'Lockout minutes', 'powerkit-powerful-tools-for-your-website' ); ?></label>
			...
			<section class="pkwt-card">
				<h2><?php esc_html_e( 'Native Endpoint Blocking', 'powerkit-powerful-tools-for-your-website' ); ?></h2>
				<div class="pkwt-field pkwt-field-inline">
					<label class="pkwt-label" for="pkwt-block-native"><?php esc_html_e( 'Block /wp-login and guest /wp-admin', 'powerkit-powerful-tools-for-your-website' ); ?></label>
					<div class="pkwt-switch-wrap">
						<input type="hidden" name="pkwt_settings[block_default_wp_auth]" value="0" />
						<label class="pkwt-switch" aria-label="<?php esc_attr_e( 'Block native endpoints', 'powerkit-powerful-tools-for-your-website' ); ?>">
				...
				<p class="description"><?php esc_html_e( 'Returns 404 for unauthenticated access to native login/admin paths.', 'powerkit-powerful-tools-for-your-website' ); ?></p>
				<div class="pkwt-info-box pkwt-info-box-warning"><?php esc_html_e( 'Emergency bypass: set POWERKIT_AUTH_RECOVERY_MODE to true in wp-config.php.', 'powerkit-powerful-tools-for-your-website' ); ?></div>
			</section>

			<section class="pkwt-card pkwt-card-span-2">
				<h2><?php esc_html_e( 'CAPTCHA', 'powerkit-powerful-tools-for-your-website' ); ?></h2>
				<div class="pkwt-field">
					<label class="pkwt-label" for="pkwt-captcha-provider"><?php esc_html_e( 'Provider', 'powerkit-powerful-tools-for-your-website' ); ?></label>
				...
				<div class="pkwt-field-grid">
					<div class="pkwt-field">
						<label class="pkwt-label" for="pkwt-recaptcha-site"><?php esc_html_e( 'reCAPTCHA Site Key', 'powerkit-powerful-tools-for-your-website' ); ?></label>
					...
					<div class="pkwt-field">
						<label class="pkwt-label" for="pkwt-recaptcha-secret"><?php esc_html_e( 'reCAPTCHA Secret Key', 'powerkit-powerful-tools-for-your-website' ); ?></label>
					...
					<div class="pkwt-field">
						<label class="pkwt-label" for="pkwt-hcaptcha-site"><?php esc_html_e( 'hCaptcha Site Key', 'powerkit-powerful-tools-for-your-website' ); ?></label>
					...
					<div class="pkwt-field">
						<label class="pkwt-label" for="pkwt-hcaptcha-secret"><?php esc_html_e( 'hCaptcha Secret Key', 'powerkit-powerful-tools-for-your-website' ); ?></label>
			...
			<section class="pkwt-card pkwt-card-span-2">
				<h2><?php esc_html_e( 'Security Operations', 'powerkit-powerful-tools-for-your-website' ); ?></h2>
				<div class="pkwt-field-grid">
					<div class="pkwt-field">
						<label class="pkwt-label"><?php esc_html_e( 'Threat status', 'powerkit-powerful-tools-for-your-website' ); ?></label>
						<div class="pkwt-info-box <?php echo $unusual_pattern ? 'pkwt-info-box-warning' : 'pkwt-info-box-success'; ?>">
							<?php echo $unusual_pattern ? esc_html__( 'Unusual activity detected. Review lockouts and recent settings changes.', 'powerkit-powerful-tools-for-your-website' ) : esc_html__( 'No unusual pattern detected.', 'powerkit-powerful-tools-for-your-website' ); ?>
						</div>
					</div>
					<div class="pkwt-field">
						<label class="pkwt-label"><?php esc_html_e( 'Rate limit monitor', 'powerkit-powerful-tools-for-your-website' ); ?></label>
						<div class="pkwt-info-box">
								<?php
								if ( ! empty( $rate_limit_status['limited'] ) ) {
									/* translators: %d: seconds until current IP lockout expires. */
									echo esc_html( sprintf( __( 'IP currently locked. Retry after %d seconds.', 'powerkit-powerful-tools-for-your-website' ), (int) $rate_limit_status['retry_after'] ) );
								} else {
									/* translators: %d: remaining attempts before IP lockout. */
									echo esc_html( sprintf( __( 'No active lockout. Remaining attempts for current IP: %d', 'powerkit-powerful-tools-for-your-website' ), (int) $rate_limit_status['remaining'] ) );
								}
								?>
						</div>
					</div>
					<div class="pkwt-field">
						<label class="pkwt-label"><?php esc_html_e( 'Last security scan score', 'powerkit-powerful-tools-for-your-website' ); ?></label>
						<div class="pkwt-info-box">
							<?php
					...
					<div class="pkwt-field">
						<label class="pkwt-label"><?php esc_html_e( 'Settings changes (24h)', 'powerkit-powerful-tools-for-your-website' ); ?></label>
						<div class="pkwt-info-box"><?php echo esc_html( (string) $recent_24h_changes ); ?></div>
					</div>
				</div>

				<div class="pkwt-field pkwt-field-inline">
					<label class="pkwt-label" for="pkwt-security-dashboard-enabled"><?php esc_html_e( 'Enable security dashboard', 'powerkit-powerful-tools-for-your-website' ); ?></label>
					<div class="pkwt-switch-wrap">
						<input type="hidden" name="pkwt_settings[security_dashboard_enabled]" value="0" />
						<label class="pkwt-switch" aria-label="<?php esc_attr_e( 'Enable security dashboard', 'powerkit-powerful-tools-for-your-website' ); ?>">
				...
				<div class="pkwt-field pkwt-field-inline">
					<label class="pkwt-label" for="pkwt-settings-activity-log"><?php esc_html_e( 'Enable settings activity logging', 'powerkit-powerful-tools-for-your-website' ); ?></label>
					<div class="pkwt-switch-wrap">
						<input type="hidden" name="pkwt_settings[settings_activity_log]" value="0" />
						<label class="pkwt-switch" aria-label="<?php esc_attr_e( 'Enable settings activity logging', 'powerkit-powerful-tools-for-your-website' ); ?>">
				...
				<div class="pkwt-field pkwt-field-inline">
					<label class="pkwt-label" for="pkwt-admin-test-mode"><?php esc_html_e( 'Test mode (administrators only)', 'powerkit-powerful-tools-for-your-website' ); ?></label>
					<div class="pkwt-switch-wrap">
						<input type="hidden" name="pkwt_settings[admin_test_mode]" value="0" />
						<label class="pkwt-switch" aria-label="<?php esc_attr_e( 'Enable admin-only test mode', 'powerkit-powerful-tools-for-your-website' ); ?>">
				...
				<div class="pkwt-field">
					<label class="pkwt-label"><?php esc_html_e( 'Plugin access roles', 'powerkit-powerful-tools-for-your-website' ); ?></label>
					<div class="pkwt-field-grid">
					...
					<p class="description"><?php esc_html_e( 'Administrators always retain access.', 'powerkit-powerful-tools-for-your-website' ); ?></p>
				</div>
			</section>
		</div>
	...
	<section class="pkwt-card pkwt-card-span-2" style="margin-top:14px;">
		<h2><?php esc_html_e( 'Settings Activity Log', 'powerkit-powerful-tools-for-your-website' ); ?></h2>
		...
		<?php if ( isset( $_GET['pkwt_notice'] ) && 'activity_log_cleared' === sanitize_key( wp_unslash( $_GET['pkwt_notice'] ) ) ) : ?>
			<div class="notice notice-success inline is-dismissible"><p><?php esc_html_e( 'Activity log cleared.', 'powerkit-powerful-tools-for-your-website' ); ?></p></div>
		<?php endif; ?>
		<?php if ( empty( $recent_activity ) ) : ?>
			<p><?php esc_html_e( 'No activity entries yet.', 'powerkit-powerful-tools-for-your-website' ); ?></p>
		<?php else : ?>
			<table class="widefat striped">
				<thead>
					<tr>
						<th><?php esc_html_e( 'Time', 'powerkit-powerful-tools-for-your-website' ); ?></th>
						<th><?php esc_html_e( 'Event', 'powerkit-powerful-tools-for-your-website' ); ?></th>
						<th><?php esc_html_e( 'User', 'powerkit-powerful-tools-for-your-website' ); ?></th>
						<th><?php esc_html_e( 'IP', 'powerkit-powerful-tools-for-your-website' ); ?></th>
						<th><?php esc_html_e( 'Option', 'powerkit-powerful-tools-for-your-website' ); ?></th>
					</tr>
				</thead>
				<tbody>
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" style="margin-top:10px;">
			...
			<button type="submit" class="button button-secondary"><?php esc_html_e( 'Clear Activity Log', 'powerkit-powerful-tools-for-your-website' ); ?></button>
		</form>
	</section>
</div>
