...
<div class="wrap pkwt-ui">
	<h1><?php esc_html_e( 'Redirect Rules', 'powerkit-powerful-tools-for-your-website' ); ?></h1>
	<?php settings_errors(); ?>
	...
	<form method="post" action="options.php" class="pkwt-settings-form">
		...
		<div class="pkwt-savebar pkwt-savebar-top">
			<div class="pkwt-savebar-text"><?php esc_html_e( 'Configure redirect behavior by role.', 'powerkit-powerful-tools-for-your-website' ); ?></div>
		...
		<div class="pkwt-card-grid">
			<section class="pkwt-card">
				<h2><?php esc_html_e( 'Filter Priority', 'powerkit-powerful-tools-for-your-website' ); ?></h2>
				<div class="pkwt-field">
					<label class="pkwt-label" for="pkwt-filter-priority"><?php esc_html_e( 'Priority', 'powerkit-powerful-tools-for-your-website' ); ?></label>
			...
			<section class="pkwt-card pkwt-card-span-2">
				<h2><?php esc_html_e( 'Role Redirects', 'powerkit-powerful-tools-for-your-website' ); ?></h2>
					...
					<?php foreach ( $roles as $role_key => $role_data ) : ?>
						<div class="pkwt-field">
							...
							<?php if ( 'administrator' === $role_key ) : ?>
								<div class="pkwt-info-box"><?php esc_html_e( 'Always redirected to admin dashboard.', 'powerkit-powerful-tools-for-your-website' ); ?></div>
							<?php else : ?>
