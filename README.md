...
[![Version](https://img.shields.io/badge/Version-3.10.4-F05032?style=for-the-badge&logo=git&logoColor=white)](https://github.com/SaddamHussainSafi/PowerPlus/releases)
...
### 3.10.4
- Guided setup wizard to enable features and create the login, register, lost-password and reset-password pages in one step.
- Refined dashboard design, motion and onboarding.

### 3.9.0
- Hidden login URL with a configurable redirect for blocked visitors, plus protection for wp-login.php and wp-admin.
- One editable page each for login, register, lost password and reset password.

### 3.8.0
- Branding module to white-label the login screen and admin area.
- One-click Elementor install and an optional auto-update-all-plugins switch.

### 3.6.0
- Strengthened SVG sanitization, login rate limiting and an IP allow-list.
- More reliable settings saving and Elementor page duplication.
