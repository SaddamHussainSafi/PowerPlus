...
class Class_PKWT_Settings_Repository {
	...
	public function defaults(): array {
		return array(
			...
			'hcaptcha_secret_key'    => '',
			'woocommerce_mode'       => 0,
			'plugin_menu_name'       => __( 'PowerKit', 'powerkit-powerful-tools-for-your-website' ),
			'plugin_description'     => __( 'Power Packed Tools - Complete WordPress Management Suite', 'powerkit-powerful-tools-for-your-website' ),
